...
public class ImgQuadTreeDisplayer extends JPanel {
    ...
    public static void main(String[] args) {
        ...
        // an empty file called imagetoquadtree.txt should be created in the package to make the imageToQuad method do its job
        TestFileFormat.imageToQuad("/Users/rakanalsyd/IdeaProjects/Project/src/smileyface.txt");
        new ImgQuadTreeDisplayer("/Users/rakanalsyd/IdeaProjects/Project/src/imagetoquadtree.txt");

    }

}

//Users/rakanalsyd/IdeaProjects/Project/src/smileyface.txt
//Users/rakanalsyd/IdeaProjects/Project/src/walkingtotheskyQT.txt